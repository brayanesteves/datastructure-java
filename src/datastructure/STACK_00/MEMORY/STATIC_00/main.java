            ...
            do {
                ...
                switch(Option) {
                    case 1:
                        try {
                            ...
                            if(!stack.isFilled()) {
                                ...
                                JOptionPane.showMessageDialog(null, "Stack fill", "The Stack filled", JOptionPane.INFORMATION_MESSAGE);
                            }
                    ...
                    case 5:
                        if(!stack.isEmpty()) {
                            JOptionPane.showMessageDialog(null, 
                                    "The element at the top is " + stack.peakStack(), 
                                    "Peak stack", 
                                    JOptionPane.INFORMATION_MESSAGE);
                        } else {
                            JOptionPane.showMessageDialog(null, 
